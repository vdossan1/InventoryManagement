...
public class TestRandomIdConstructorInvoked {
	...
	public void testNameIsNull() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Produce(null, 1, LocalDate.of(2017, 02, 12));
		});
	}
	...
	public void testNameIsEmpty() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Produce("", 1, LocalDate.of(2017, 02, 12));
		});
	}
	...
	public void testCostIsZero() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Produce("name", 0, LocalDate.of(2017, 02, 12));
		});
	}
	...
	public void testCostIsNegative() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Produce("name", -1, LocalDate.of(2017, 02, 12));
		});
	}
	...
	public void testValidArguments() {
		...
		Produce result = new Produce("name", 1, expirationDate);
